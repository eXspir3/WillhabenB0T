...
public class SearchBots {
	...
	public void addNew(SearchBot searchBot) throws Exception {
	...
	public SearchBot get(int index) throws Exception {
	...
	public SearchBot get(String name) throws Exception {
		for (int i = 0; i < searchBots.size(); i++) {
	...
	public void set(int index, SearchBot searchbot) throws Exception {
		if (searchBots.size() <= index) {
			throw new Exception("Searchbot with ID " + index + " not found!");
		}
